...
class tap_activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        db!!.child("users").child(fba!!.uid).child("8conversation").child("2chattype").child("toperson1").child("received1").setValue("r")
        db!!.child("users").child(fba!!.uid).child("8conversation").child("2chattype").child("toperson1").child("received2").setValue("r")
        db!!.child("users").child(fba!!.uid).child("8conversation").child("2chattype").child("toperson2").child("received3").setValue("r")
        db!!.child("users").child(fba!!.uid).child("8conversation").child("2chattype").child("toperson2").child("sent1").setValue("s")
        db!!.child("users").child(fba!!.uid).child("8conversation").child("2chattype").child("toperson3").child("sent2").setValue("s")
        db!!.child("users").child(fba!!.uid).child("8conversation").child("2chattype").child("toperson3").child("sent3").setValue("s")
